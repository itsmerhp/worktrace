...
use frontend\models\ResetAppPasswordForm;
...
//------------------------------------------------------------------------------------------------//
    ...
    /**
     * Displays the Policy static page.
     *
     * @return string
     */
    ...
    {
        return Yii::$app->controller->renderPartial('policy');
    }
    
    /**
     * Web view for Terms static page.
     *
     * @return string
     */
    public function actionTermsCondition()
    {
        return Yii::$app->controller->renderPartial('terms');
    }
    
    /**
     * Displays the Terms static page.
     *
     * @return string
     */
...
//------------------------------------------------------------------------------------------------//
    ...
    public function actionResetAppPassword($token)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate() && $model->resetPassword())
        {
            //Yii::$app->session->setFlash('success', 'New password has saved.');
            return $this->redirect('password-reset-successfully');
            //return $this->goHome();
        }
        else
        {
