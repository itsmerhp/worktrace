...
<div class="pages-form">
    ...
    <div class="box-body">
		...
		<div class="row">		
			<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
				<?php
				$dataCuisines = [];
				$dataCuisines = ArrayHelper::map(Cuisines::find()->
				 asArray()->where(['status'=>1])->orderBy(['name'=>SORT_ASC])->all(),'id', 'name');    

				echo $form->field($model, 'cuisine_id')->dropDownList($dataCuisines,['prompt'=>'Select Cuisine']);
				?>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
				<?php echo $form->field($model, 'image',['options'=>['class'=>'form-group field-restaurant-restaurant_logo  col-xs-12 col-sm-12 col-md-12 col-lg-6','style'=>'padding:0']])->widget(Widget::className(), [
						'uploadUrl' => yii\helpers\Url::toRoute('/meals/uploadPhoto'),
						'maxSize'	=>	5242880,
						'cropAreaWidth'	=>	500,
						'cropAreaHeight'	=>	500,
						'height'	=> 500,
    ...
    <div class="box-footer">
		...
		<?= Html::a(Yii::t('app', 'Cancel'), Yii::$app->urlManager->createUrl(['meals']), ['class' => 'btn btn-default']) ?>
	</div>
