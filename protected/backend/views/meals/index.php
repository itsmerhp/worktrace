...
/* @var $searchModel common\models\Meals */
...
<section class="content-header">
	...
	<p style="margin: 10px 0 0">
		...
		<?= Html::a(Yii::t('app', 'Reset'), Yii::$app->urlManager->createUrl(['meals']), ['class' => 'btn btn-primary']) ?>
	</p>
				...
				'columns' => [
					...
					[
						...
						'value'  => function($data){
							...
							return Html::a($icon, Yii::$app->urlManager->createUrl(['meals/active','id' => $data->id]), 
								[
