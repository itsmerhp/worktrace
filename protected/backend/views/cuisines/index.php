...
<section class="content-header">
	...
	<p style="margin: 10px 0 0">
		...
		<?= Html::a(Yii::t('app', 'Reset'), Yii::$app->urlManager->createUrl(['cuisines']), ['class' => 'btn btn-primary']) ?>
	</p>
				...
				'columns' => [
					...
					[
						...
						'value'  => function($data){
							...
							return Html::a($icon, Yii::$app->urlManager->createUrl(['cuisines/active','id' => $data->id]), 
								[
